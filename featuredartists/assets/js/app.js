document.addEventListener("DOMContentLoaded", () => {
    const people = [
        ...
        {
            "number": 29,
            "title": "Анна Царук, 27 років",
            "description": "Киянка Анна Царук досліджує теми ідентичності, спільноти, міграції та травми. Робота “Мішки з піском перед церквою Пресвятої Євхаристії у Львові” із серії “Сподіваюсь, твоя сімʼя в безпеці” (2023) знята у Львові, куди фотографка, яка вже 9 років мешкає в Берліні, приїхала, щоб зафіксувати життя країни посеред війни. Твори Анни демонструють ніжний, чуттєвий погляд на сучасну Україну.",
            "instagram": {
